...
echo -e "     ${DIM}• ${CYAN}hello T1234 world${NC} ${DIM}→ Temporary unlock (T+password prefix)${NC}"
echo -e "     ${DIM}• ${CYAN}abc P1234 def${NC} ${DIM}→ Permanent unlock (P+password prefix)${NC}"
echo -e "     ${DIM}• ${CYAN}test 1234 end${NC} ${DIM}→ Default temporary unlock${NC}"
echo ""
